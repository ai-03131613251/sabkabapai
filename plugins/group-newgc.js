...
cmd({
  ...
  try {
    ...
    if (err.message?.includes("401") || err.message?.includes("not authorized")) {
      ...
      await reply("❌ Invalid phone number(s) provided.\nEnsure numbers are in international format: 923161483125");
